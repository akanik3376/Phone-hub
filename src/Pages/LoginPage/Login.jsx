...
const Login = () => {
    return (
        <div className="flex container mt-10 justify-center items-center  ">

            <div className="relative flex w-80 h-2/4  flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
